...
{"t":"KB","d":"systems","x":"kilobyte","alias":["MB","GB","TB","kilobyte","megabyte","gigabyte"],"g":"Sizes. A byte is about one letter. A thousand of them is a KB, a million an MB, a billion a GB. A thousand GB is a TB."},
...
{"t":"JVM","d":"systems","x":"Java Virtual Machine","alias":["DEX","CIL"],"g":"A pretend computer that real computers imitate, so one program can run anywhere without being rebuilt for each machine."},
...
{"t":"GCC","d":"systems","x":"GNU Compiler Collection","alias":["MSVC","Clang"],"g":"Programs that turn source code into something a machine can run. Different ones, same job, and they disagree in the corners."},
{"t":"JSON","d":"data","x":"JavaScript Object Notation","alias":["XML","CSV"],"g":"Plain-text ways of writing data down so two programs can pass it between them. Readable by a person, at a pinch."},
...
{"t":"MPI","d":"systems","x":"Message Passing Interface","alias":["OpenMP","TBB"],"g":"Ways of splitting one job across many processors or many machines, and getting the pieces back in order."},
{"t":"CFI","d":"security","x":"Control Flow Integrity","alias":["RTTI","SafeStack"],"g":"A guard that checks a program only jumps where it was built to jump, so an attacker cannot redirect it mid-run."},
...
{"t":"COOP","d":"security","x":"Cross-Origin-Opener-Policy","alias":["COEP"],"g":"Two headers a web server can send to wall a page off from other pages. Some browser features are only allowed behind them."},
