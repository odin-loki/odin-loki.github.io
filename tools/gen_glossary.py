...
{"t":"ML","d":"ai","g":"Usually machine learning: getting a program to work something out from examples rather than from rules. On the language page it is an old family of languages instead."},
...
{"t":"LMS","d":"ai","alias":["normalised-LMS"],"g":"Nudging a set of weights towards a better answer after every single example. How far it nudges depends on how wrong it just was."},
...
{"t":"UHPM","d":"ai","g":"Unified Hash-Predictive Memory. It looks things up and works things out with one set of sums, rather than bolting memory onto a model afterwards."},
...
{"t":"FFT","d":"maths","g":"A fast way of breaking a signal into the simple waves that make it up. It is one of the most used pieces of maths in computing."},
...
{"t":"BFS","d":"maths","g":"Exploring a network by taking every step one hop from where you are before going any deeper. It finds the shortest route first."},
{"t":"DFS","d":"maths","g":"Exploring a network by following one path as far as it goes, then backing up and trying the next. Uses far less memory than the alternative."},
...
{"t":"RMSE","d":"maths","g":"The usual way of saying how far off a set of guesses was, on average. Big misses count for more than small ones, on purpose."},
{"t":"LLR","d":"maths","g":"A single number saying which of two answers the evidence favours, and by how much. Positive one way, negative the other, zero for no idea."},
{"t":"EMA","d":"maths","g":"A running average that quietly forgets the past: each new number counts a little, and everything older fades. Cheap, and it never has to store the history."},
{"t":"RBF","d":"maths","g":"A way of measuring how alike two things are that only cares how far apart they sit. Similar things score high, distant things score near zero."},
...
{"t":"LSTM","d":"ai","g":"A kind of neural network with a memory it can choose to keep or wipe, built for sequences. It was the standard before attention took over."},
...
{"t":"SGD","d":"ai","g":"How most models are trained: look at a small batch, nudge the settings a little in the direction that helps, repeat millions of times."},
{"t":"BPTT","d":"ai","g":"Training something that reads a sequence by unrolling it into one long chain. The blame for the final answer is then traced back through every step."},
...
{"t":"OOD","d":"ai","g":"Data that looks nothing like anything the model was trained on. Its answers there stop meaning much, and it will usually not admit that."},
{"t":"ORF","d":"ai","g":"A tidier version of the random-features trick, where the random directions are spread out evenly rather than drawn at random. Building it here found a real bug."},
...
{"t":"NLP","d":"ai","g":"Getting software to handle written language. On this site it means the old rule-based kind, chosen because a police tool has to be able to explain itself."},
]
